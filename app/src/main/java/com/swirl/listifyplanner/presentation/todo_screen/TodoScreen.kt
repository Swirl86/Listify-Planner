...
import com.swirl.listifyplanner.presentation.todo_screen.components.MyTopAppBar
import com.swirl.listifyplanner.presentation.todo_screen.components.TodoCard
                            ...
                            TodoCard(
                                ...
                                onDelete = {
                                    ...
                                    snackbar(
                                        scope,
                                        snackbarHostState,
                                        message = UiText.StringResource(R.string.todo_deleted_task, todo.task).asString(context),
                                        actionLabel = UiText.StringResource(R.string.todo_undo_delete).asString(context),
